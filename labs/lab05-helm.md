...
- Helm installed.
- kubectl installed for client-side schema validation.

## Before You Begin

Complete Labs 01 - 04 first. This lab uses local Helm rendering only and does not install the chart into Kubernetes.
