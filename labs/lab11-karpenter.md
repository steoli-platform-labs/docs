...
5. Validate Karpenter readiness and configuration:
...
6. Create a temporary workload that cannot fit on existing nodes, then watch provisioning:
...
7. Clean up the temporary namespace after validation:
